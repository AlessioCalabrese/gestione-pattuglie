...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // In produzione: sostituire con l'origine reale del frontend se servito separatamente
        // (non necessario se FE e BE sono nella stessa build/porta, come da requisito).
